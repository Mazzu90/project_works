        		...
        		<div class="row">
                    ...
                    <div class="col-xs-12" align="center">
    					<form action="ricerca.php">
                            <button type="submit" class="btn m-btn search mt-none" id="nResultVetFture"> VEDI TUTTE LE <?php echo SiteManager::$numero_veicoli ?> AUTO </button>
                        </form>
