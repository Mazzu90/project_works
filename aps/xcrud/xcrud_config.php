...
class Xcrud_config
{
     /*
     // produzione
    public static $dbname = 'Sql1035543_1'; // Your database name
    public static $dbuser = 'Sql1035543'; // Your database username
    public static $dbpass = 'b7115u4yy2'; // // Your database password
    public static $dbhost = '89.46.111.32'; // Your database host, 'localhost' is default.
    */
    // sviluppo
    public static $dbhost = 'prod-mysql2';
    public static $dbuser = 'autounica';//autounica
    public static $dbpass  = '6ejZHsQwcX8795y5';//
    public static $dbname = 'autounica'; //autounica
    ...
    public static $upload_folder_def = '../../archivio_img/img_o'; // Default uploads folder on your site, relative to xCRUD folder or absolute path required. Folder is must exist.
