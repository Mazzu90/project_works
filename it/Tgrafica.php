...
class Tgrafica
{
    ...
    public static $classeOggetto ='Veicolo';
    
    public static function getClasseOggetto(){
        return self::$classeRicerca;
    }
    
    public static function getOggetto($search){
        return new self::$classeOggetto($search);
    }    
    ...
    <html >
        ...
        <body class="m-index m-detail">
            ...
            <!--header -->
            <? if($this->codicePagina!=Properties::cp_stampa)
                 $this-> headerHTML() ?>
            <!--header end-->
    ...
    {
        echo '<br>Grafica: Header Standard';
    ...
    ?>
        ...
        <link rel="icon" type="image/png" href="<?echo Properties::base_url?>images/iconAutoUnica.png" />
        
        <meta name="description" content="<?=$this->description?>" />
        <meta name="keywords" content="<?=$this->keywords?>" />
        <meta name="content-language" content="<?=Properties::lingua?>" />
        
        <link href="<?echo Properties::base_url?>css/master.css" rel="stylesheet">
	...
	function headerHTML()
    {
        echo '<br>Grafica: HeaderHtml';
        ?>
        	
            <?
				if ($this->codicePagina==Properties::cp_homepage)
				{
			?>
			...
			<nav class="b-nav" id="headerMenu">
				<div class="row">
					<div class="col-md-1 col-xs-12 pr-none ml-md">
						<a href="<?echo Properties::base_url.Properties::lingua?>/index.php"><div class="b-nav__logo"></div></a>
					</div>
						...
						<div class="b-nav__list">
							...
							<div class="navbar-main-slide side-collapse in" id="nav">
								<ul class="navbar-nav-menu">
									...
									<? $menuAttivo=($this->codicePagina==Properties::cp_chisiamo)?' current ':'' ?>
									<li class="<?=$menuAttivo?>"><a href="<?echo Properties::base_url.Properties::lingua?>/chisiamo.php">Chi Siamo</a></li>
									
									<? $menuAttivo=($this->codicePagina==Properties::cp_servizi)?' current ':'' ?>
									<li class="<?=$menuAttivo?> dropdown"><a class="dropdown-toggle" href="<?echo Properties::base_url.Properties::lingua?>/servizi.php">Servizi <!--<span class="fa fa-caret-down"></span>--></a>
										<!--<ul class="dropdown-menu h-nav">
											<li><a href="<?echo Properties::base_url.Properties::lingua?>/servizi.php">ESTENSIONE DI GARANZIA</a></li>
											<li><a href="<?echo Properties::base_url.Properties::lingua?>/servizi.php">AUTO SOSTITUTIVA</a></li>
											<li><a href="<?echo Properties::base_url.Properties::lingua?>/servizi.php">PACCHETTI ALL INCLUSIVE</a></li>
										</ul>-->
									</li>
									
									<? $menuAttivo=($this->codicePagina==Properties::cp_officina)?' current ':'' ?>
									<li class="<?=$menuAttivo?> dropdown"><a class="dropdown-toggle" href="<?echo Properties::base_url.Properties::lingua?>/officina.php">Officina <!--<span class="fa fa-caret-down"></span>--></a>
										<!--<ul class="dropdown-menu h-nav">
											<li><a href="<?echo Properties::base_url.Properties::lingua?>/officina.php">ANALISI</a></li>
											<li><a href="<?echo Properties::base_url.Properties::lingua?>/officina.php">GARANZIA</a></li>
											<li><a href="<?echo Properties::base_url.Properties::lingua?>/officina.php">PREPARAZIONE AUTO</a></li>
										</ul>-->
									</li>
									
									<? $menuAttivo=($this->codicePagina==Properties::cp_compriamo)?' current ':'' ?>
									<li class="<?=$menuAttivo?>"><a href="<?echo Properties::base_url.Properties::lingua?>/comproautobrescia.php">Compriamo la tua auto</a></li>

									<? $menuAttivo=($this->codicePagina==Properties::cp_marchi)?' current ':'' ?>
									<li class="<?=$menuAttivo?>"><a href="<?echo Properties::base_url.Properties::lingua?>/autovetture.php">Marchi</a></li>

									<? $menuAttivo=($this->codicePagina==Properties::cp_contatti)?' current ':'' ?>
									<li class="<?=$menuAttivo?>"><a href="<?echo Properties::base_url.Properties::lingua?>/contatti.php">Contatti</a></li>

									<? $menuAttivo=($this->codicePagina==Properties::cp_tutteleauto)?' current ':'' ?>
									<li class="icon <?=$menuAttivo?> no-phone"><a href="<?echo Properties::base_url.Properties::lingua?>/ricerca.php"><i class="icon-magnifier icon icon-2x"></i><span>Ricerca Auto</span></a></li>
			...
			<nav class="b-nav bg-blue" id="headerMenu">
				<div class="row">
					<div class="col-md-1 col-xs-12 pr-none ml-md">
						<a href="<?echo Properties::base_url.Properties::lingua?>/index.php"><div class="b-nav__logo white"></div></a>
					</div>
        ...
        echo '<br>Grafica: Fine headerHtml';
    }
    
     function Footer()
    {
        echo '<br>Grafica: Footer';
        ?>
        <!-- FOOTER -->
        
        <footer class="b-footer">
			<a id="to-top" href="#this-is-top"><img src="<?echo Properties::base_url?>images/top.png"></a>
			<div class="container">
				...
				<div class="row pb-md">
                    ...
                    <div class="col-md-2 col-sm-3 col-xs-6 mobile-none">
                    	<div class="b-footer__company mt-md">
                            <a href="<?echo Properties::base_url.Properties::lingua?>/chisiamo.php">CHI SIAMO</a>
							<br>
                            <a href="<?echo Properties::base_url.Properties::lingua?>/servizi.php">SERVIZI</a>
                            <br>
                            <a href="<?echo Properties::base_url.Properties::lingua?>/servizi.php#garanzia">ESTENSIONE DI GARANZIA</a>
                            <br>
                            <a href="<?echo Properties::base_url.Properties::lingua?>/officina.php">OFFICINA</a>
                            <br>
                    ...
                    <div class="col-md-2 col-sm-3 col-xs-6 mobile-none">
                    	<div class="b-footer__company mt-md black">
                            <a href="<?echo Properties::base_url.Properties::lingua?>/comproautobrescia.php">COMPRIAMO LA TUA AUTO</a>
                            <br />
                            <a href="<?echo Properties::base_url.Properties::lingua?>/autovetture.php">MARCHI</a>
                            <br />
                            <a href="<?echo Properties::base_url.Properties::lingua?>/contatti.php">CONTATTI</a>
                            <br />
                            <a href="<?echo Properties::base_url.Properties::lingua?>/ricerca.php">RICERCA AUTO</a>
                    	</div>
					</div>
                    
					<div class="col-md-2 col-sm-3 col-xs-6 mobile-none">
						<div class="b-footer__company mt-md black">
                        	<a href="<?echo Properties::base_url.Properties::lingua?>/privacy.php">Privacy Policy</a>
                        	<br>
                        	<a href="<?echo Properties::base_url.Properties::lingua?>/cookie.php">Utilizzo dei Cookie</a>
                        	<br>
                        	<a href="<?echo Properties::base_url.Properties::lingua?>/FAQ.php">FAQ</a>
						</div>
					</div>
              	</div>
        ...
        <!--Main-->   
		<script src="<?echo Properties::base_url?>js/jquery-1.11.3.min.js"></script>
        <script src="<?echo Properties::base_url?>js/jquery-ui.min.js"></script>
        <script src="<?echo Properties::base_url?>js/bootstrap.min.js"></script>
		<script src="<?echo Properties::base_url?>js/modernizr.custom.js"></script>
		...
		<script src="<?echo Properties::base_url?>assets/rendro-easy-pie-chart/dist/jquery.easypiechart.min.js"></script>
		<script src="<?echo Properties::base_url?>js/waypoints.min.js"></script>
		<script src="<?echo Properties::base_url?>js/jquery.easypiechart.min.js"></script>
		<script src="<?echo Properties::base_url?>js/classie.js"></script>
		
		<!--Chosen Select Costumize-->
		<script src="<?echo Properties::base_url?>js/chosen.jquery.min.js"></script>
		<script>
			var config = {
			  '.chosen-select'           : {},
		...
		<!--Owl Carousel-->
		<script src="<?echo Properties::base_url?>assets/owl-carousel/owl.carousel.min.js"></script>
		<!--bxSlider-->
		<script src="<?echo Properties::base_url?>assets/bxslider/jquery.bxslider.js"></script>
		<!-- jQuery UI Slider -->
		<script src="<?echo Properties::base_url?>assets/slider/jquery.ui-slider.js"></script>

		<!--Theme-->
		<script src="<?echo Properties::base_url?>js/jquery.smooth-scroll.js"></script>
		<script src="<?echo Properties::base_url?>js/wow.min.js"></script>
		<script src="<?echo Properties::base_url?>js/jquery.placeholder.min.js"></script>
		<script src="<?echo Properties::base_url?>js/theme.js"></script>
				...
				<div class="row">
					<div class="col-md-2 col-sm-4 col-xs-12 mb-xxl">
                        <div class="b-count__service__item j-last">
                            <img src="<?echo Properties::base_url?>images/icon-home/icon-200auto.svg" class="box_icon_width_small">
                    ...
                    <div class="col-md-2 col-sm-4 col-xs-12 mb-xxl">
                        <div class="b-count__service__item">
                        	<img src="<?echo Properties::base_url?>images/icon-home/icon-garanzia.svg" class="box_icon_width_small">
                            <h2>garanzia</h2>
                    ...
                    <div class="col-md-2 col-sm-4 col-xs-12 mb-xxl">
                        <div class="b-count__service__item j-last">
                            <img src="<?echo Properties::base_url?>images/icon-home/icon-compriamo.svg" class="box_icon_width_small">
					...
					<div class="col-md-2 col-sm-4 col-xs-12 mb-xxl">
                        <div class="b-count__service__item j-last">
                            <img src="<?echo Properties::base_url?>images/icon-home/icon-certificazione.svg" class="box_icon_width_small">
                    ...
                    <div class="col-md-2 col-sm-4 col-xs-12 mb-xxl">
                        <div class="b-count__service__item j-last">
                            <img src="<?echo Properties::base_url?>images/icon-home/icon-finanziamenti.svg" class="box_icon_width_small">
                            <h2>finanziamenti</h2>
                    ...
                    <div class="col-md-2 col-sm-4 col-xs-12 mb-xxl">
                        <div class="b-count__service__item j-last">
                            <img src="<?echo Properties::base_url?>images/icon-home/icon-assicurazione.svg" class="box_icon_width_small">
                            <h2>assicurazione</h2>
            ...
            <h1>Richiedi informazioni</h1>
             <div class="form">
                    <form id="ContactForm" method="POST" action="contatti_action.php">
                        ...
                        <div style="display:none"><div id="privacy"><h3>Informativa sulla Privacy</h3><p>Ai sensi del D. Lgs. 196/03, i dati raccolti verranno utilizzati esclusivamente per informare periodicamente in merito alle attivitÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â  ed alle iniziative di <b><?=Properties::RAGIONE_SOCIALE?></b> e non verranno diffusi a terzi.
                        <br /><br />
                        Il conferimento dei dati ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¨ facoltativo, tuttavia senza riferimenti personali non sarÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â  possibile fornire i servizi richiesti. L'interessato puÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â² esercitare i diritti di cui all'art. 7 del D. Lgs. 196/03. Il titolare del trattamento dati ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¨ <b><?=Properties::ragione_sociale?></b></p></div></div>
      ...
      $limit='';
        ...
        else
        {
            if ($pagina>0)
                ...
                //$limit=' limit '.(($this->pagina-1)*Properties::NUMERO_RECORD_PAGINA_SMALL).','.Properties::NUMERO_RECORD_PAGINA_SMALL;
        }    
        */
...
function stampaVeicoliSimili($elencoAuto)
{
    ...
    {
        if (Properties::URL_REWRITE_ATTIVO)
                        {
                            $path = Properties::base_url.Properties::lingua.'/'.normalizzaTesto($veicolo['make']).'/'.normalizzaTesto($veicolo['model']).'-'.normalizzaTesto($veicolo['version']).'_'.$veicolo['id'].'.htm';
                        }
                        else
                        {
                            $path = Properties::base_url.Properties::lingua.'/dettaglio-auto.php?id='.$veicolo['id'];   
                        }
        ?>
...
function linguette($marca, $modello, $carrozzeria, $annoA, $annoDa, $prezzoDa, $prezzoA, $carburante, $kmDa, $kmA, $potenza, $potenzaDa, $potenzaA, $neopatentati, $cambio, $nPorte, $nPostiDa, $nPostiA, $abs, $cruise, $clima, $fari, $classeEmissioni, $citycar,  $ecologic)
{
    ...
    ?>
  	<ul>
								<?echo$linguetta?>
								<li class="remove"><a href="<?Properties::base_url?>ricerca.php?r=1">Rimuovi filtri</a></li>
							</ul>
                            <!-- 
                            ...
                            <div class="b-items__cars-one  " data--delay="0.5s">
                                            ...
                                            <?
                                             ...
                                             if ($etichetta)
                                             {
                                                ...
                                                <span class="etichettaCorner m-premium">
                                                	<img src="<?=$veicolo->img?>" class="img-responsive"/>
                                                </span>
                                                <?
                                             }
                                            ?> 
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <img src="<?= $veicolo->img?>" alt='auto01' class="img-responsive"/>
                                                        </div>
                                                    <script type="text/javascript">		
                                    ...
                                    <div class="col-lg-4 col-sm-12 col-xs-12 mt-elenco-auto">
                                        ...
                                        <header class="b-items__cars-one-info-header s-lineTopLeft s-lineDownLeft mb-elenco-auto">
											...
											<span><sup>€</sup><?echo number_format($veicolo->prezzo,0,',','.')?></span>
										</header>
                                        ...
                                        $data = new Data();?>
                                            ...
                                            <p class="icon-carinfo data larg50"><?echo $data->estraiDataAuto($veicolo->registration_date)?></p>
                                        ...
                                        <button type="submit" onclick="window.location='<?echo $path?>'" class="btn m-btn lightblue mt-md" style="width: 100%;">SCOPRI DI PIù </button>
