...
{global $prezzo, $carrozzeria, $cambio, $benzina, $diesel, $gpl, $metano, $elettrica, $ibrida, $marca, $neopatentati, $pagina, $nContenutiDaEstrarre, $numeroRecordPerPagina ;
			...
			<div class="container">
				<div class="row b-bottom">
                            ...
                            while ($row=mysql_fetch_assoc($result)) {
                                ...
                                echo '<option value="'.$row['body'].'" '.$selectedBody.'>'.$row['body'].'</option>';
                                            ...
                                            <div class="b-items__aside-main-body-item">
                                                ...
                                                <div>
                                                    <select name="modelloAuto" class="m-select filter" id="modelloAuto">
                                        ...
                                        <footer class="b-items__aside-main-footer">
                                            ...
                                            <br clear="all">
                                            <a class="f-right" href="<?echo costantiP::BASE_URL.costantiP::LINGUA?>/elenco_auto.php?r=1"><span class="icon-aperta-quadra"></span>RESET FILTRI<span class="icon-plus"></span><span class="icon-chiusa-quadra"></span></a>
                                            <br />
                                            <form class="b-search__main" action="elenco_auto.php" method="POST">
                    ...
                    <? define('FIRST', 0);
                        ...
                        <div id="elencoauto">
                          <?
                          $elencoAuto = estraiVeicoli($prezzo, $carrozzeria, $cambio, $benzina, $diesel, $gpl, $metano, $elettrica, $ibrida, $marca, $neopatentati, $pagina, $nContenutiDaEstrarre, $numeroRecordPerPagina, FIRST,LIMIT);
                          ...
                          <div class="col-lg-12 col-sm-12 col-xs-12 mb-xl pr-none">
                            <div class="b-items__cars-one  " data--delay="0.5s">
                                    <div class="col-lg-8 col-sm-8 col-xs-12"  >
                                        ...
                                        <div id="auto_<?echo $veicolo['id']?>" class="carousel slide"  data-ride="carousel" data-interval="false" style="width: 480px;">
                                            ...
                                            <?
                                                    $sql = 'select immagini.* from immagini where immagini.id_veicolo = '.$veicolo['id'].' limit 1,10';
                                            ...
                                            foreach ($immaginiVeicolo as $imgV) {
                                                ?>    
                                               <div class="item">
                                                  <img src="<?echo costanti::IMG_PERCORSO_BASE.costanti::IMG_PERCORSO_ORIGINALE.$imgV['img']?>" alt='<?echo $imgV['titolo']?>' class="img-responsive"/>
                                    ...
                                    <div class="col-lg-4 col-sm-4 col-xs-12 mt-elenco-auto">
                                        <header class="b-items__cars-one-info-header s-lineTopLeft s-lineDownLeft mb-elenco-auto"><span><?echo $veicolo['prezzo']?> €</span></header>
     ...
     <script>
        $(document).ready(function() {
            ...
            $('#marca').change(function() {
                ...
                {
                    $("#modelloAuto").html(msg);//stampa i risultati dentro la seconda select
                },
                error: function()
                {
