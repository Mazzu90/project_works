...
//se ho ricevuto qualcosa in post imposto la sessione con quel valore e la relativa variabile che user� per la query
...
isset($_GET['potenza'])?$_GET['potenza']:$potenza=$_SESSION['potenza'];
...
$grafica->codicePagina=Properties::cp_tutteleauto;
...
{global $grafica, $kWatt, $postiSedere, $prezziVeicoli, $annoDa, $annoA, $kmDa, $kmA, $potenzaDa, $potenzaA, $potenza, $classeEmissioni, $carburante, $abs, $cruise, $clima, $fari, $nPostiDa, $nPostiA, $kmVeicoli, $prezzo, $prezzoDa, $prezzoA, $carrozzeria, $nPorte, $cambio, $benzina, $diesel, $gpl, $metano, $elettrica, $ibrida, $marca, $modello, $neopatentati, $citycar, $ecologic, $pagina, $nContenutiDaEstrarre, $numeroRecordPerPagina ;
                                        ...
                                        <div class="b-items__aside-main-body">
											...
											<div class="b-items__aside-main-body-item mt-lg">
                                                ...
                                                <div>
													...
													<select name="alimentazione" class="m-select filter dark auto_submit_filter" id="alimentazione">
                                                    <?
                                                    $selected = '';
...
<?
		...
		<section class="b-featured preFooter">
			<div class="container">
				<div class="col-xs-12">
					<h2 class="title">PERCH� SCEGLIERE AUTOUNICA</h2>
				</div>
			</div>	
		</section>
     ...
     <script>
        ...
        $(document).ready(function() {
                ...
                //chiamata ajax
                        ...
                        data: "id_marca=" + marca +"&id_modello=" +modello,
                        dataType: "html",
                    ...
                    //recupero variabile "discriminante"
                        var potenza = $("#kwatt").val();
                        var potenzaDa = $("#kwattDa").val();
                        var potenzaA = $("#kwattA").val();
                        //chiamata ajax
