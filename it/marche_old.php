    ...
    )
{
   ...
   $sql = 'select 
            ...
            from
                marca
             where marca.titolo_normalizzato = "'.$idMarca.'"';
   ...
   $sql = 'select 
    ...
    GetRecord( $sql , $rowMarca);

    if ($rowMarca['titolo']=='' || $rowMarca['id']==null)
     {
        $url = costantiP::BASE_URL.costantiP::LINGUA.'/ricerca.php';
        header('location: '.$url);
    }

$grafica->titolo=$rowMarca['titolo'].' usata - Brescia - AUTOUNICA srl';
$grafica->keywords=$rowMarca['titolo'].', auto usate, veicoli usati, vendita auto usate Brescia';
$grafica->description='Ampio showroom con oltre 200 vetture disponibili, galleria fotografica di '.$rowMarca['titolo'].' in vendita presso il nostro Showroom in via Valcamonica a Brescia';
...
//isset($_GET['marca'])?$marca=$_GET['marca']:$marca='-1';
                    ...
                    <? define('FIRST', 0);
                        ...
                        <div id="elencoauto">
                         ...
                         <div class="col-lg-12 col-sm-12 col-xs-12 mb-xl pr-none pl-xlg">
                                ...
                                <h2 class="mt-none"><?echo $rowMarca['titolo']?></h2>
                          ...
                          if (!$elencoAuto || $elencoAuto =='')

                                      {
                                        ...
                                        // SE VOLESSI VISULIZZARE TUTTE LE AUTO DISPONIBILI SENZA FILTRARE MARCA E MODELLO
