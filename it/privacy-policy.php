    ...
    ?>
            <div id="slide" class="interne">
              	<div class="testo-slide">
                	<div class="titolo-slide-interne">PRIVACY<br/>POLICY
                    </div>
                    <div class="sottotitolo-slide-interne">Informativa ai sensi del D. Lgs 196/2003</div>
                </div>
              <div class="clearfix"></div></div>
            
   	<div id="content">
   	  	<h1 class="interne margintop50">Informativa (ai sensi del D. lgs. N. 196 del 30 Giugno 2003)</h1>
   	  		<div id="mappasito">
            	<p>La presente Privacy Policy ha lo scopo di descrivere le modalità di gestione di questo sito, in riferimento al trattamento dei dati personali degli utenti/visitatori che lo consultano.
                    L’informativa è resa anche ai sensi dell’articolo 13 del D.Lgs. 196/03 – Codice in materia di protezione dei dati personali – a coloro che si collegano al sito di pietrobelliezizioli.it all’indirizzo www.pietrobelliezizioli.it e si ispira anche alla Raccomandazione n. 2/2001 che le autorità europee per la protezione dei dati personali, riunite nel Gruppo istituito dall’art. 29 della direttiva n. 95/46/CE, hanno adottato il 17 maggio 2001 per individuare alcuni requisiti minimi per la raccolta di dati personali on-line, e, in particolare, le modalità, i tempi e la natura delle informazioni che i titolari del trattamento devono fornire agli utenti quando questi si collegano a pagine web, indipendentemente dagli scopi del collegamento.
                    ...
                    Il sito sopra indicato è di proprietà e gestione dello Studio Associato di Architettura Pietrobelli e Zizioli.
                    Si invitano gli utenti/visitatori a leggere attentamente la presente Privacy Policy prima di inoltrare qualsiasi tipo di informazione personale e/o compilare qualunque modulo elettronico presente sul sito stesso.
                      ...
                      <p>Il Titolare del trattamento è Studio Associato di Architettura Pietrobelli e Zizioli, con Sede legale Via IV Novembre, 11 - 25086 Rezzato (BS). Responsabili del trattamento dei dati personali sono i soggetti dell’Azienda incaricati di tale gestione.</p>
                      <h3 class="margintop30">LUOGO DI TRATTAMENTO DEI DATI</h3>
                      <p>I trattamenti connessi ai servizi web di questo sito hanno luogo presso la predetta sede e sono curati solo da personale tecnico dell’Ufficio incaricato del trattamento.</p>
                      <h3 class="margintop30">TIPOLOGIA DI DATI TRATTATI E FINALITÀ DEL TRATTAMENTO</h3>
                       <h4>1. Dati di navigazione</h4>
                      <p>II sistemi informatici e le procedure software preposte al funzionamento di questo sito web acquisiscono, nel corso del loro normale esercizio, alcuni dati personali la cui trasmissione è implicita nell’uso dei protocolli di comunicazione di Internet.
                    ...
                    Se si utilizza Google Chrome, dal menu Strumenti selezionare Opzioni (Preferenze per Mac), accedere ad Avanzate quindi all’opzione Configurazione Contenuto della sezione Privacy e infine spuntare Cookie nel menu Configurazione del contenuto.
                      ...
                      <p>A parte quanto specificato per i dati di navigazione, l’utente è libero di fornire i dati personali riportati nei moduli di richiesta a pietrobelliezizioli.it per chiedere approfondimenti, delucidazioni o altre comunicazioni.
                    ...
                    pietrobelliezizioli.it, servizio privacy - Sede legale Via IV Novembre, 11 - 25086 Rezzato (BS) - studio @ pietrobelliezizioli.it</p>
