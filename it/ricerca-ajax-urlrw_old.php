...
isset($_POST['marca'])?$marca=$_POST['marca']:$marca=$_POST['marca'];
...
isset($_POST['modello'])?$modello=$_POST['modello']:$modello='';
...
$elencoAuto = estraiVeicoli2($prezzo, $carrozzeria, $cambio, $benzina, $diesel, $gpl, $metano, $elettrica, $ibrida, $marca, $modello, $neopatentati, $pagina, $nContenutiDaEstrarre, $numeroRecordPerPagina, $start, $limit2,'0');
